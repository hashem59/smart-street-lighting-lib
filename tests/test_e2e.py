...
class TestE2EDesign:
    def test_full_pipeline_fitzroy_gardens(self):
        ...
        from smart_street_lighting.core.pipeline import run_design
        ...
        with patch("smart_street_lighting.core.pipeline.resolve_osm_pathway", return_value=fixture):
    ...
    def test_pipeline_with_explicit_params(self):
        ...
        with patch("smart_street_lighting.core.pipeline.resolve_osm_pathway", return_value=None):
            design, calc_report, spatial, dimming, context = run_design(
                mock_data,
                "test query",
...
class TestE2EIntent:
    def test_new_design_classified(self):
        from smart_street_lighting.core.intent import classify_intent
...
class TestE2EValidator:
    def test_validate_real_report(self):
        ...
        from smart_street_lighting.llm.calculation_engine import design_lighting, format_design_report
        from smart_street_lighting.core.validator import validate_report
