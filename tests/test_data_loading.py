...
class TestSpatialAnalysis:
    ...
    def test_haversine_distances_reasonable(self):
        from smart_street_lighting.data.load_melbourne_data import load_pedestrian_data, load_streetlight_data
        from smart_street_lighting.data.spatial_analysis import match_sensors_to_lights
    ...
    def test_efficiency_categories_valid(self):
        from smart_street_lighting.data.load_melbourne_data import load_pedestrian_data, load_streetlight_data
        from smart_street_lighting.data.spatial_analysis import match_sensors_to_lights, analyze_lighting_efficiency
...
class TestTemporalAnalysis:
    ...
    def test_hourly_profile_24_hours(self):
        from smart_street_lighting.data.load_melbourne_data import load_pedestrian_data
        from smart_street_lighting.data.temporal_analysis import add_temporal_features, get_hourly_profile
